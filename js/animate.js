...
~function () {
    ...
    var tweenEffect = {
        ...
        na1: function (t, b, c, d) {
        return c * (t /= d) * t * t + b;},

        na2: function(t, b, c, d) {
            return -c * (Math.sqrt(1 - (t /= d) * t) - 1) + b},
        na3: function (t, b, c, d) {
            return c * (t /= d) * t + b;
        },
        na4:function (t, b, c, d) {
            return c * (t /= d) * t * t + b;
        },
        na5:function (t, b, c, d) {
            return c * (t /= d) * t * t * t + b;
        },
        na6: function (t, b, c, d) {
            return c * (t /= d) * t * t * t * t + b;
        },
        na7:function (t, b, c, d) {
            return -c * Math.cos(t / d * (Math.PI / 2)) + c + b;
        },
        na8:function (t, b, c, d) {
